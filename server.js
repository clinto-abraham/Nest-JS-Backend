...
app.use(morgan('dev', { skip: function (req, res) { return res.statusCode < 400 } })) // log only 4xx and 5xx responses to console
...
app.listen(port, async () => {
  ...
  console.dir(`File Upload Express.js Backend app listening on port ${port}`)
